...
class ReadUserController {
    ...
    async handleReadAnyUsers(req, res) {
        ...
        try {
            ...
            if (profession && typeof profession !== 'string') {
                throw new Error(`Profession não pode ser nulo e '${ERROR_MESSAGES_USER.INVALID_TYPE_PROFESSION}'`);
            }
            if (accessLevel && typeof accessLevel !== 'string' ) {
                throw new Error(`Nivel de acesso não pode ser nulo e '${ERROR_MESSAGES_USER.INVALID_TYPE_ACCESSLEVEL}'`);
            }
    ...
    async handleReadUniqueUser(req, res) {
        ...
        try {
            ...
            if(isNaN(parsedID)) {
                throw new Error(`ID não pode ser nulo e '${ERROR_MESSAGES_USER.INVALID_TYPE_ID}'`);
            }
